...
namespace DevExpress.Web.Demos {
	...
	public static class Utils {
		...
		static string GetInfoMessageForTreeControl(bool forTreeLines) {
			...
			return String.Format("By design, the {0} themes do not display {1}. Switch to a different theme to view and manipulate {2} setting in this demo.", result, infoFeatures, infoFeature);
		}
	}
